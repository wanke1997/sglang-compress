...
class Scheduler:
    ...
    def __init__(
        ...
        if server_args.compress_algorithm is not None:
            global compress_algorithm
            compress_algorithm = server_args.compress_algorithm
            self.enable_overlap = False
            logger.info("Overlap scheduler is disabled for compression algorithms.")
        ...
        if (
            ...
            and server_args.disable_radix_cache or server_args.compress_algorithm is not None
        ):
