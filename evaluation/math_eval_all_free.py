...
def main_all(args):
    ...
    #     "deepseek-r1-distill-llama-8b_256",
    #     "deepseek-r1-distill-llama-8b_512",
    #     "deepseek-r1-distill-llama-8b_1024"
    # ]
    ...
    # for deepseek_folder in folders:
        ...
        for dataset_item in os.listdir(deepseek_path):
            ...
            if os.path.isdir(dataset_path):
                ...
                # files = ["h2o_step.json", "SnapKV_step.json", "PyramidKV_step.json", "SnapKV_step_sim_v2.json"]
                for file in files:
                    if file.endswith(".json") or file.endswith(".jsonl"):
