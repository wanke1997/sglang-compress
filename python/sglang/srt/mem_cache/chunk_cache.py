...
class ChunkCache(BasePrefixCache):
    def __init__(
        self, req_to_token_pool: ReqToTokenPool, token_to_kv_pool: BaseTokenToKVPool, compress_algorithm: Optional[str] = None
    ):
        self.disable = True
        self.req_to_token_pool = req_to_token_pool
        self.token_to_kv_pool = token_to_kv_pool
        self.compress_algorithm = compress_algorithm
        # NOTE: This is a map to store compressed request length. Once updated to ScheduleBatch in the 
        # prepare_for_decode() function, it will be removed
        self.compressed_req_len = {}
